...
$(document).ready(function () {
    ...
    var gameGo = $("#gameStartButton").on("click", function(){
        $("#startScreen").css("display", "none");
        $("#gamePlay").css("display", "block");
        $("body").css("background-image", "url(./assets/images/hotel.jpeg)");

        triviaStart();
        var gameSubmit = $("#gameSubmitButton").on("click", questionCheck);
    });
    ...
    function timerCountDown() {
        timerNumberStart--;
        $("#runningTimer").html(timerNumberStart + " Seconds");
    ...
    function questionCheck() {
        ...
        if (correctQuestionCount >= 6) {
            $("body").css("background-image", "url(./assets/images/medal.jpeg)");
            $("body").css("background-position", "center");
        } else {
            $("body").css("background-image", "url(./assets/images/track.jpeg)");
        }

        $("#unansweredQuestions").html(unansweredQuestionCount);
        $("#correctQuestions").html(correctQuestionCount);
        $("#incorrectQuestions").html(incorrectQuestionCount);
        return false;
